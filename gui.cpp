...
void statisticMenu(MenuContext& mainMenu, NhanVien *& danhSach) {
    const vector<string> stats = {
        ...
        "C. Phan bo nhan vien theo chuc vu",
        "D. Bieu do thong ke luong nhan vien"
    };
    ...
    while (true) {
        ...
        switch (choice) {
            case 0:
                controlThongKePhongBan(danhSach);
                break;  
            case 1:
                controlThongKeMucLuong(danhSach);
                break;  
            case 2:
                controlThongKeChucVu(danhSach);
                break;
            case 3:
                controlThongKeLuongTheoPB(danhSach);
                break;
            default:
                console::gotoxy(MENU_X, MENU_Y + STATISTIC_OFFSET_Y + 22);
                cout << "Chuc nang dang phat trien..."; getch();
